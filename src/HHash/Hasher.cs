...
{
    /// <summary>
    /// Create and validate hierarchical identifiers
    /// </summary>
	public class Hasher
	{
        ...
        /// </summary>
        /// <param name="parts">the path of the identifier hierarchy</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Validate an existing identifier
        /// </summary>
        /// <param name="id">a previously create hierarchical identifier</param>
        /// <param name="parts">the path to the identifier</param>
        /// <returns>true is the identifier was created as part of the given hierarchy, otherwise returns false</returns>
